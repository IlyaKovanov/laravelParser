...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
      class="bg-white dark:bg-gray-950 scheme-light dark:scheme-dark h-full">
    <head>
        <meta charset="UTF-8">
        <meta name="viewport"
    ...
    <body class="h-full">
        <main class="grid min-h-full place-items-center bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
            <div class="text-center">
                <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Page html Parser</h1>
                <p class="mt-6 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">To use the services of the service,
                    you must log in or register if you do not have an account yet.</p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="{{route('register')}}"
                       class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Registration</a>
                    <a href="{{route('login')}}" class="text-sm font-semibold text-white">Login <span
