                            ...
                            <div class="border-b border-white/10 pb-12">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea id="url_list" name="url_list" rows="3" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"></textarea>
                                        </div>
                            ...
                            <div class="border-b border-white/10 pb-12">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input id="selector" type="text" name="selector" autocomplete="address-level1" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2 grid grid-cols-1">
                                            <select id="selector_type" name="selector_type" autocomplete="country-name" class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white/5 py-1.5 pr-8 pl-3 text-base text-white outline-1 -outline-offset-1 outline-white/10 *:bg-gray-800 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6">
                                                <option>text</option>
